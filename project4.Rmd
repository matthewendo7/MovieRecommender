...
Our first approach is to display the user with the most popular movies for a given genre. We define most popular as the movies with the most number of 4 and 5 ratings. Our thinking behind choosing 4,5 is that it will result in good movies, and also, taking the number of ratings, we will factor in the popularity of the movie as well. Furthermore, We will only show a movie if there are alteast 100 4 and 5 ratings to ensure sufficient number of users have rated the movie.
